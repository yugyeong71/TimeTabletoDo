...
class CreateDialog extends StatefulWidget {
  ...
  CreateDialog({Key? key, required this.lectures, required this.subjectsController, required this.professorController,
                required this.placeController, required this.selectedDateValue, required this.selectedValue1,
                required this.selectedValue2,required this.newColorname}) : super(key: key);
                ...
                TextButton(
                    onPressed: () {
                      setState(() { //버튼을 눌렀을 때 값이 객체 안으로 들어가며 상태가 설정됨.
                        widget.lectures.add(Detail(widget.newColorname, widget.subjectsController.text,
                            widget.professorController.text, widget.selectedDateValue,
                            widget.selectedValue1, widget.selectedValue2, widget.placeController.text,[]));
